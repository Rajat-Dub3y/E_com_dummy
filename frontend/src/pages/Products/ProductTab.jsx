...
const ProductTab = ({loadingProductReview,userInfo,submitHandler,rating,setRating,comment,setComment,product}) => {
                        ...
                        {userInfo ? (
                            <form onSubmit={submitHandler} >
                                <div className="my-2">
                                    ...
                                    <select id="rating" required value={rating} onChange={(e)=>setRating(Number(e.target.value))} className="p-2 border rounded-lg xl:w-[40rem] text-black">
                                        <option value="" >Select</option>
                                        <option value="1" >Inferiro</option>
                                ...
                                <button type="submit" disabled={loadingProductReview} className="bg-pink-600 text-black py-2 px-4 rounded-lg">
                    ...
                    <div>
                        ...
                        <div>
                            {product.reviews.map((review)=>(
                                <div key={review._id} className="bg-white p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem] xl:w-[50rem] sm:w-[24rem] mb-5">
